...
const nextQuestions = (answer) => {
  ...
  if (questions.length > 0) {
    ...
    validate(currentQuestion, document.getElementById(answer).innerHTML);
  }

  document.getElementById("question_index").innerHTML = qIndex;
...
const showFinalResults = () => {
  ...
  questionsContainer.innerHTML =`<h1> Final score: ${score} / ${amount.value}<h1>`;
};
